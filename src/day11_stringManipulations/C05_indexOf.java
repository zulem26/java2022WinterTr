...
public class C05_indexOf {
    ...
    public static void main(String[] args) {
        ...
        //istersek bir harf ya da metin olarak verdigimiz String in idexini dondurur
        ...
        System.out.println(str1.indexOf("b")); //(5) buldugu ilk b yi indexi yazdirir

        System.out.println(str1.indexOf('b',5));
        //bu method da fromIndex olarak yazdigimiz index den baslar
        //(inclusive)


        //verilen String deki 2.a harfinin index ini bulalim
        //2.a harfini bulabilmek icin once ilkini bulup sonra 2.a yi bulmamiz gerekir
        ...
        //2.b harfini bulabilmek icin once ilkini bulup sonra 2.a yi bulmamiz gerekir
        ...
        // OZET : indexOF method u icerirse yazilan String veya char in
