...
public class C01_Iterator {
    public static void main(String[] args) {
        ...
        Iterator itr = liste.iterator();    //iterator methodunu olusturdugumuz liste objesi uzerinden
                                            // ArrayList class indan calistiriyoruz

        /*
        iterator nasil calisir
        bir iterator objesi olusturmak icin collection uyesi bir obje kullanmaliyiz
        yani biz bu iterator objesini bizim ornegimizde liste objesi uzerinde calismak icin
        olusturmus olduk
        Biz iterator objesini olusturdugumuzda iterator collection in ilk elementinin oncesine
        gidip bekler
        [(itr)5, 7, 8, 6, 9]
        itr.hasNext() ====> true iterator a yaninda eleman var mi diye sorar, true veya false dondurur

        itr.next();==> iterator bir sonraki elementin yanina gecer ve uzerinden gectigi elementi dondurur
        ...
        iterator un bir element olmasini saglamaliyiz
         */
