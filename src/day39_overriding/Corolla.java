...
public class Corolla extends Toyota{
    protected String hiz = "Corolla maksimum 200 km hiz yaparlar";
    ...
    public static void main(String[] args) {
        ...
        /*
            Data turu ve constructor farkli oldugunda Constructor calistigi icin obje Constructor in
            oldugu class ozelliklerini tasir ancak Data turu Parent class secildigi icin
            variable lar data turunun secildigi class ve onun parent class larindan deger alabilir

            Methodlar icin ise yine Data turunun oldugu class a gideriz. Ancak direkt method u
            calistirmadan once method Override edilmis mi diye kontrol ederiz
         */
        ...
        arb3.motor(); //Corolla
        // arb3.garanti();  aramaya Araba class indan basladi bulamadi CTE
