...
public class C03_MDArrays {
    public static void main(String[] args) {
        ...
        int sini24[][] = new int[3][24];
        int sinif22[][] = new int[2][22];

        //olustururken elementleri atama yaparsak farkli uzunlukta inner array ler tanimlayabiliriz

        int arr1[][]={{3,1,7}, {6,10,2}}; //direkt tanimaladigimiz icin itiraz etmiyor
