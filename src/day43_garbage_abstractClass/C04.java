...
public abstract class C04 {
    /*
    bir abstract class da abstract veye concrete method lar bulunabilir
    ...
    public static void main(String[] args) {
        ...
        Abstract class lar OBJE BARINDIRMAYAN, sadece child class lar icin UYULMASI SART OLAN veya
        OPSIYONEL BIRAKILAN ozellikleri tanimaladigimiz bir depo class gibidir
