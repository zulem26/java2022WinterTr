...
public class StaticKeyword {
    ...
    public static void main(String[] args) {
        /*Static variable lar direkt class a baglidir.
          ...
          Instance variable lara obje uzerinden erisilebilir
          ve bir obje uzerinden erisilerek yapilan degisiklik instance variable in degerini
          tum objeler icin kalici olarak degistirmez sadece o obje icin instance variable
          degerini kalici olarak degistirir
         */


        System.out.println(sayi1); //0
        //System.out.println("sayi2 : " + sayi2);  static olmadigi icin main method dan direkt kullanilamaz
