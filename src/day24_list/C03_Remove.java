...
public class C03_Remove {
    public static void main(String[] args) {
        ...
        sayilar.add(5); //[5]
        sayilar.add(3); //[5, 3]
        sayilar.add(0, 7); //[7, 5, 3]   index 0 a 7 eklendi
        sayilar.add(2, 7); //[7, 5, 7, 3]     index 2 ye 7 eklendi

        sayilar.remove(3); // index olarak 3 deki elementi siler
        sayilar.remove(5); //IndexOutOfException  hatasi verir
        ...
        // int sayi=5;
        //sayilar.remove(sayi); //IndexOutOfException
